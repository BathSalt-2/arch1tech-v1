...
export function VisualLogicDesigner() {
  ...
  const nodes = [
    { id: 'input', type: 'input', label: 'User Query', x: 50, y: 200, status: 'active' },
    { id: 'memory', type: 'memory', label: 'Customer Context', x: 200, y: 100, status: 'stable' },
    { id: 'crm', type: 'integration', label: 'CRM Lookup', x: 200, y: 300, status: 'stable' },
    { id: 'llm', type: 'logic', label: 'LLM Processing', x: 350, y: 200, status: 'optimizing' },
    { id: 'sentiment', type: 'analysis', label: 'Sentiment Check', x: 500, y: 150, status: 'stable' },
    { id: 'response', type: 'output', label: 'Generate Response', x: 650, y: 200, status: 'active' },
  ];
